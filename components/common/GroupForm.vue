      ...
      <SheetContent side="bottom" class="h-[50%]">
        ...
        <SheetDescription class="flex flex-col gap-3">
          ...
          <div class="relative">
            <Input
              type="text"
              placeholder="Implment landing page"
              v-model.trim.lazy="groupForm.name"
              required="true"
              tabindex="-1"
              class="text-[16px]"
            />
            <component
              v-if="groupForm.name.length"
              @click="onClearForm"
              :is="X"
          ...
          <div class="relative">
            <Input
              ...
              required="true"
              tabindex="-1"
              class="text-[16px] absolute inset-0 w-full h-full cursor-pointer opacity-0"
